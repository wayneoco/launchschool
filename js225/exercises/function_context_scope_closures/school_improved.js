...
let tess = school.addStudent('Tess', '1st');
school.enrollStudent(tess, 'Math', 101);
school.addGrade(tess, 'Math', 90);
school.getReportCard(tess);
tess.info();
console.log(tess.listCourses());
